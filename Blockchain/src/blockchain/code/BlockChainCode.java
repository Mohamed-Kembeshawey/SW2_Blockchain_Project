...
public class BlockChainCode {
	...
	public BlockChainCode(int difficulty) {
		super();
	...
	public  Block mining(Transactions trans,String ph)
		{
			String hash="";
	...
	public boolean addBlock(Block block)
        {
            System.out.println("The ph:"+my_Chain.get(my_Chain.size()-1).getHash()+" the ph in b:"+block.getPrev_hash());
            if(my_Chain.get(my_Chain.size()-1).getHash().equals(block.getPrev_hash()))
            {
                my_Chain.add(block);
                return true;
            }
